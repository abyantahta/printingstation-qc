        ...
        <div class="w-3/4 shadow-xl h-96 mt-8 p-12 flex gap-12">
            ...
            <div class="w-1/2 flex flex-col gap-y-4">
                ...
                <form action="{{ route('print.label') }}" method="POST" class="w-full">
                    ...
                    <button type="submit" class="bg-blue-300 mt-4 font-bold hover:brightness-110 hover:duration-200 border-2 h-12 rounded-sm cursor-pointer w-full">Download PDF</button>
                </form>
            </div>
        </div>
    </div>
